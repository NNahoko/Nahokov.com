...
var ApolloClient = (function () {
    function ApolloClient(options) {
        ...
        if (!cache) {
            throw process.env.NODE_ENV === "production" ? new InvariantError(2) : new InvariantError("To initialize Apollo Client, you must specify a 'cache' property " +
    ...
    ApolloClient.prototype.query = function (options) {
        ...
        process.env.NODE_ENV === "production" ? invariant(options.fetchPolicy !== 'cache-and-network', 3) : invariant(options.fetchPolicy !== 'cache-and-network', 'The cache-and-network fetchPolicy does not work with client.query, because ' +
