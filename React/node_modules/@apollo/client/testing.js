...
function getFragmentQueryDocument(document, fragmentName) {
    ...
    document.definitions.forEach(function (definition) {
        if (definition.kind === 'OperationDefinition') {
            throw process.env.NODE_ENV === "production" ? new invariant.InvariantError(43) : new invariant.InvariantError("Found a " + definition.operation + " operation" + (definition.name ? " named '" + definition.name.value + "'" : '') + ". " +
    ...
    if (typeof actualFragmentName === 'undefined') {
        process.env.NODE_ENV === "production" ? invariant.invariant(fragments.length === 1, 44) : invariant.invariant(fragments.length === 1, "Found " + fragments.length + " fragments. `fragmentName` must be provided when there is not exactly 1 fragment.");
...
function getFragmentFromSelection(selection, fragmentMap) {
    switch (selection.kind) {
        ...
        case 'FragmentSpread': {
            ...
            process.env.NODE_ENV === "production" ? invariant.invariant(fragment, 45) : invariant.invariant(fragment, "No fragment named " + selection.name.value + ".");
            return fragment;
        }
        default:
            return null;
...
function shouldInclude(_a, variables) {
    ...
    return getInclusionDirectives(directives).every(function (_a) {
        ...
        if (ifArgument.value.kind === 'Variable') {
            ...
            process.env.NODE_ENV === "production" ? invariant.invariant(evaledValue !== void 0, 39) : invariant.invariant(evaledValue !== void 0, "Invalid variable referenced in @" + directive.name.value + " directive.");
        }
        else {
...
function getInclusionDirectives(directives) {
    ...
    if (directives && directives.length) {
        directives.forEach(function (directive) {
            ...
            process.env.NODE_ENV === "production" ? invariant.invariant(directiveArguments && directiveArguments.length === 1, 40) : invariant.invariant(directiveArguments && directiveArguments.length === 1, "Incorrect number of arguments for the @" + directiveName + " directive.");
            var ifArgument = directiveArguments[0];
            process.env.NODE_ENV === "production" ? invariant.invariant(ifArgument.name && ifArgument.name.value === 'if', 41) : invariant.invariant(ifArgument.name && ifArgument.name.value === 'if', "Invalid argument for the @" + directiveName + " directive.");
            var ifValue = ifArgument.value;
            process.env.NODE_ENV === "production" ? invariant.invariant(ifValue &&
                (ifValue.kind === 'Variable' || ifValue.kind === 'BooleanValue'), 42) : invariant.invariant(ifValue &&
...
var ObservableQuery = (function (_super) {
    ...
    ObservableQuery.prototype.refetch = function (variables) {
        ...
        if (fetchPolicy === 'cache-only') {
            return Promise.reject(process.env.NODE_ENV === "production" ? new invariant.InvariantError(1) : new invariant.InvariantError('cache-only fetchPolicy option should not be used together with query refetch.'));
        }
...
var ApolloClient = (function () {
    function ApolloClient(options) {
        ...
        if (!cache) {
            throw process.env.NODE_ENV === "production" ? new invariant.InvariantError(2) : new invariant.InvariantError("To initialize Apollo Client, you must specify a 'cache' property " +
    ...
    ApolloClient.prototype.query = function (options) {
        ...
        process.env.NODE_ENV === "production" ? invariant.invariant(options.fetchPolicy !== 'cache-and-network', 3) : invariant.invariant(options.fetchPolicy !== 'cache-and-network', 'The cache-and-network fetchPolicy does not work with client.query, because ' +
        ...
        workSet.forEach(function (selection) {
            ...
            if (isField(selection)) {
                ...
                if (typeof value !== 'undefined') {
                    ...
                    throw process.env.NODE_ENV === "production" ? new invariant.InvariantError(52) : new invariant.InvariantError("Missing field '" + resultFieldKey + "' in " + JSON.stringify(result, null, 2).substring(0, 100));
                }
            }
            else {
...
var ApolloProvider = function (_a) {
    ...
    return React.createElement(ApolloContext.Consumer, null, function (context) {
        ...
        process.env.NODE_ENV === "production" ? invariant.invariant(context.client, 9) : invariant.invariant(context.client, 'ApolloProvider was not passed a client instance. Make ' +
